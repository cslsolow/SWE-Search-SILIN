...
2. **Locate Code**"""
  ...
  * **Secondary Method - ViewCode:** Only use when you need to see:
    ...
    # if "ViewCode" in [a.__class__.__name__ for a in actions]:
    #     if "FindCalledObject" in [a.__class__.__name__ for a in actions]:
  #   prompt += """
  # * **Secondary Method - Further Functions:** Use these to find the called objects and relevant context:
  #     * FindCalledObject - Search code for the objects that are referenced or called in the current code but whose implementation has not yet been found, Use this when additional context is not provided by searches
  #     * ViewCode - See the additional context, specific line ranges you discovered from search results and code referenced in error messages or test failures
  #         """

  #       prompt += """
  # * **Secondary Method - Further Functions:** Use these to find the called objects and relevant context:
  #     * ViewCode - See the additional context, specific line ranges you discovered from search results and code referenced in error messages or test failures
  #     * FurtherViewCode - Search code for the objects that are referenced or called in the current code but whose implementation has not yet been found, Use this when additional context is not provided by searches
  #     """
